...
import Approve from "./tab/tabapprove";
...
function Wodetail({ match }) {
  ...
  const changeMenu = (menuIndex) => {
    setTab({ menu: menuIndex });
  };

  const domdelete = () => {
    const dom = document.getElementsByClassName(" card-body");
  };
            ...
            <div class="card card-primary card-outline card-outline-tabs">
              <div class="card-header p-0 border-bottom-0">
                <ul
                  ...
                  role="tablist"
                >
                  <li class="nav-item" onClick={() => changeMenu(2)}>
                    <a
                  ...
                  <li class="nav-item" onClick={() => changeMenu(1)}>
                    <a
                      class="nav-link"
                      id="custom-tabs-one-home-tab"
                      data-toggle="pill"
